<?php
  ...
  foreach($files as $file) {
        ...
        $filelist .= '<li><a href="../../mviewerjs.html?pMode=2&pTime=2000&mp3=./books/mids/Mozart, Symphony No. 40 in g minor, Molto allegro.mid&title=Slide Show: '.$file.'&file=./books/pdfs/'.$file.'">'.$file.'</a></li>';
        $sizelist .= '<li>'.sizeFilter(filesize($file)).'</li>';
        $timelist .= '<li>'.date('M d Y H:i', $date).'</li>';
        clearstatcache();
  }
?>
<h3>List of all PDF files with link to mViewerJS with auto play and MIDI accompaniment:</h3>
<table><tr><pre>
